...
public class GameController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            SpawnNextTitle(i >= initNoObstacles);
        }
    }
    ...
    public void SpawnNextTitle(bool spawnObstacles = true){
        var newTile = Instantiate(tile, nextTileLocation, nextTileRotation);

        /// Figure out where ans at what rotation we should spawn the next item.
